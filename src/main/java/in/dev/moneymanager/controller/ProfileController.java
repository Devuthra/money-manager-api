...
import in.dev.moneymanager.dto.AuthDTO;
import in.dev.moneymanager.entity.ProfileDTO;
import in.dev.moneymanager.service.ProfileService;
...
public ResponseEntity<String> resendMail(@RequestParam String email){
    ...
    return ResponseEntity.ok(
            profileService.resendActivationMail(email)
    );
}
}